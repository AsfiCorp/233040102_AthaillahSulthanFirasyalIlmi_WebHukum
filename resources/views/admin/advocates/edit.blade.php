...
@section('title', "Edit Advocate - Admin")
@section('page-title', 'Edit Advocate')
...
<div class="mx-auto" style="max-width:768px;">
    ...
    <div class="p-8 md:p-12" style="background:#1c2541; border:1px solid rgba(233,195,73,0.2);">
        <h2 class="mb-8" style="font-family:'Playfair Display',serif; font-size:32px; color:#e9c349;">Edit: {{ $advocate->name }}</h2>
        ...
        <form action="{{ route('admin.advocates.update', $advocate) }}" method="POST" enctype="multipart/form-data" class="space-y-6">
            @csrf @method('PUT')
            ...
            <div>
                ...
                <input type="text" id="name" name="name" required value="{{ old('name', $advocate->name) }}"
            ...
            <div>
                ...
                <select id="role" name="role" required
                    ...
                    <option value="{{ $role }}" {{ old('role', $advocate->role) === $role ? 'selected' : '' }}>{{ $role }}</option>
                    @endforeach
                </select>
            </div>
            ...
            <div>
                ...
                <textarea id="short_story" name="short_story" rows="5"
                          ...
                          onfocus="this.style.borderColor='rgba(233,195,73,0.5)'" onblur="this.style.borderColor='rgba(69,70,77,0.3)'">{{ old('short_story', $advocate->short_story) }}</textarea>
            </div>
            ...
            <div>
                ...
                <p class="mb-3" style="font-size:12px; color:#c6c6ce; opacity:0.7;">Accepted: JPG, PNG — Max: 2MB. Leave empty to keep current photo.</p>
            ...
            <div class="pt-4 flex gap-4">
                <button type="submit"
                    ...
                    <span class="material-symbols-outlined" style="font-size:18px;">save</span> Update Advocate
                </button>
                <a href="{{ route('admin.advocates.index') }}"
                   class="flex items-center gap-2 font-bold transition-colors"
